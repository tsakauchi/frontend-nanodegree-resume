...
var HTMLskills = '<li class="flex-item"><span class="white-text padded">%data%</span></li>';
...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    var name = placeData.formatted_address.replace(", USA","");   // name of the place from the place service
    ...
    // open/close infoWindow in click listener
